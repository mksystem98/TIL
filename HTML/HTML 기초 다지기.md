...
1. HTML의 기본 문법을 학습한다.
2. 배운 내용을 정리한다. 무작정 복사 붙여넣기를 하지 않는다.
3. 배운 내용을 토대로 간단한 페이지를 만들어본다.
...
```html
<label for="select">감독을 선택하세요: </label>
    <select name="name" id="select">
        <option value="">--선택하세요--</option>
        <option value="봉준호">봉준호</option>
        <option value="이와이 슌지">이와이 슌지</option>
        <option value="데미언 셔젤">데미언 셔젤</option>
        <option value="크리스토퍼 놀란">크리스토퍼 놀란</option>
    </select>
```
...
위에서 배운 내용을 토대로 '나의 인생영화 TOP 4' 페이지를 만들어 볼 것이다.


1. HTML 상용구를 생성하고 그 안에 태그들을 넣는다.

2. title은 "나의 인생영화 TOP 4" 이다.

3. 목록 요소 `<ul>` 를 통해 영화 4개를 나열한다.

4. 앵커 태그로 각 영화의 나무위키 사이트로 이동할 수 있는 링크를 생성한다.

5. 각 영화의 이미지를 하나씩 삽입한다.

6. 시맨틱 요소(hr, br), 마크업(header, footer, nav, article, section, main,)를  활용한다.

7. HTML Table로 영화 표를 생성해보자.

8. HTML Form을 사용하여 영화에 대한 퀴즈를 만들어본다.
        ...
        <main>
            <section>
                <ul>
                    <li>
                        <a
                            href="https://namu.wiki/w/%EA%B8%B0%EC%83%9D%EC%B6%A9(%EC%98%81%ED%99%94)"
                            >기생충</a
                        >
                        - 봉준호
                        <br />
                        <img
                            src="https://i.namu.wiki/i/LG48s9dnDuaM0jtpn_VhNk8ZmYHlWKOoyTEdZ2nSPZN8ftgTRNlp5SlqtD69sfZIQVZ9ORqqvn9Kzd4DUusUYglJpKwZByBjy-wWfI1FAUVkQmqXsDGHLON8OCyTggjkC-0zgtwXYbzf-VbL_3rb0w.webp"
                            alt=""
                            width="100"
                            height="150"
                        />
                    ...
                    <li>
                        <a
                            href="https://namu.wiki/w/%EC%9D%B8%ED%84%B0%EC%8A%A4%ED%85%94%EB%9D%BC"
                            >인터스텔라</a
                        >
                        - 크리스토퍼 놀란
                        <br />
                        <img
                            src="https://i.namu.wiki/i/RK8lkKLfQ85wKol55PPFN_GhCQMDzRyFwRQDut0PysdvH15JhjjXB5-EM00q36uGBAnnVAMF0ca0JYoGB84KmfkGfRGEuE1NVRRyJB9mTa1L445T05Plp7cCwsLn6TYZxn0xBRgeoQSmtf0HW1MC1Q.webp"
                            alt="인터스텔라"
                            width="100"
                            height="150"
                        />
                    ...
                    <li>
                        <a
                            href="https://namu.wiki/w/%EC%9C%84%ED%94%8C%EB%9E%98%EC%89%AC"
                            >위플래쉬</a
                        >
                        - 데미언 셔젤
                        <br />
                        <img
                            src="https://i.namu.wiki/i/rJHfgrQ4D45DHJGszOMqdDk9lUOCMQDNGPeAy1QyeLtsPHcacyooJ7b8NbxRX4ybCIc9vH0Cfdk_a3ablKmZAgF5xiOXUaOSw67ABeyxEruN32Ql2m-nI9_3TLKNkt5gNRrOBQlNx3vZp-SBPgW8lw.webp"
                            alt=""
                            width="100"
                            height="150"
                        />
                    ...
                    <li>
                        <a
                            href="https://namu.wiki/w/%EB%9F%AC%EB%B8%8C%EB%A0%88%ED%84%B0(%EC%9D%BC%EB%B3%B8%20%EC%98%81%ED%99%94)"
                            >러브레터</a
                        >
                        - 이와이 슌지
                        <br />
                        <img
                            src="https://i.namu.wiki/i/7Akozk7iUAvXcErJwfb077j0n7DxqV91sQ06sXqdVyVO4L6G6JzhFxx53fTGGDpbS4WgHGRy3-AMq2nuZXnuJ8NXJPcKjaJ4d0ZgjByNb-_sVOxwQQYZY-s_X8povmqhQoPhzWxP4FkYVEYZJ2wCCw.webp"
                            alt=""
                            width="100"
                            height="150"
                        />
            ...
            <section>
                <h2>영화 퀴즈</h2>
                <form action="/anywhere">
                    <h2>다음 중 봉준호 감독의 영화를 고르시오</h2>
                    <p>
                        <label for="기생충">기생충: </label>
                        <input
                            type="radio"
                            id="기생충"
                            name="movie"
                    ...
                    <h2>영화 인터스렐라를 연출한 감독 이름을 고르시오</h2>
                    <p>
                        <label for="select">감독을 선택하세요: </label>
                        <select name="name" id="select">
                            <option value="">--선택하세요--</option>
...
<img width="462" alt="image" src="https://github.com/mksystem98/TIL/assets/147119824/3029adc1-4ba4-4ebb-8837-cacbc0067e2a">